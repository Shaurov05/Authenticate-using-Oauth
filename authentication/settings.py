...
SECRET_KEY = '8bj%+&df7#bw5df=^1jb%4)!bj(nan@%gqcw&01ba_l7o!($oh'
...
SOCIAL_AUTH_FACEBOOK_KEY = 'your client id'  # App ID
SOCIAL_AUTH_FACEBOOK_SECRET = 'your secret key'  # App Secret
